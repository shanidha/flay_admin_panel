...
// import 'package:flay_admin_panel/features/products/presentation/pages/add_product_screen.dart';
...
// import '../../../categories/presentation/pages/add_category_screen.dart';
...
//             (index) => _buildSideBarItem(  controller.sections[index],controller.sections[index].icon,
...
// //   Widget _buildSideBarItem(SectionModel section,IconData icon, String title, int index) {
// //     return Obx(() {
// //       final isSelected = controller.currentSectionIndex.value == index;
// //          final iconPath = isSelected ? section.iconSelected : section.iconUnselected;
...
// //                   ),
// //                  //     _SidebarIcon(path: iconPath, size: 20),
// //                   if (controller.sidebarOpen.value)
// //                     SizedBox(
// //                       width: 15,
// //                     ),
...
//   final String path;
//   final double size;
//   const _SidebarIcon({required this.path, this.size = 20});
